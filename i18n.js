...
M['xdoc-badge']={zh:'&#9679; 工具',en:'&#9679; Tool'};
M['home-card-doc']={zh:'论文排版工具',en:'Paper Format Tool'};
M['xdoc-p']={zh:'论文格式一键排版：自动识别学校模板、图片表格零丢失、Markdown 与 LaTeX 公式支持、排完自动质检出改动报告。完全本地运行，断网可用。',en:'One-click paper formatting: auto school-template parsing, zero content loss, Markdown & LaTeX support, auto quality report. Fully local.'};
M['home-card-doc-p-full']={zh:'论文格式一键排版：自动识别学校模板、图片表格零丢失、Markdown 与 LaTeX 公式支持、排完自动质检出改动报告。完全本地运行，断网可用。',en:'One-click paper formatting: auto school-template parsing, zero content loss, Markdown & LaTeX support, auto quality report. Fully local.'};
M['xdoc-tease']={zh:'排版 · 质检报告 · 本地运行 · 开源',en:'Format · Report · Local · Open Source'};
M['home-card-doc-arrow']={zh:'查看工具 →',en:'View Tool →'};
M['nav-haina']={zh:'海纳平台',en:'Haina'};
M['xhaina-badge']={zh:'&#9679; AI 平台',en:'&#9679; AI Platform'};
M['home-card-haina']={zh:'海纳：海洋知识平台',en:'Haina: Ocean Platform'};
M['xhaina-p']={zh:'线上真实运行的海洋知识平台（hainahub.cn）：15+ 官方信源数据聚合、12 个物种分布模型、带溯源与合规标识的 LLM 智能解读，从数据工程到 AI 解读全链路独立交付。',en:'A live ocean knowledge platform (hainahub.cn): 15+ official data sources, 12 species distribution models, provenance-aware LLM interpretation, delivered end to end via AI pair development.'};
M['home-card-haina-p-full']={zh:'线上真实运行的海洋知识平台（hainahub.cn）：15+ 官方信源数据聚合、12 个物种分布模型、带溯源与合规标识的 LLM 智能解读，从数据工程到 AI 解读全链路独立交付。',en:'A live ocean knowledge platform (hainahub.cn): 15+ official data sources, 12 species distribution models, provenance-aware LLM interpretation, delivered end to end via AI pair development.'};
M['xhaina-tease']={zh:'多源数据 · 物种分布模型 · LLM 解读 · 在线运行',en:'Data · SDM · LLM · Live'};
M['xhaina-arrow']={zh:'线上体验 →',en:'Visit Live →'};