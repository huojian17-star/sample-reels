...
window.__MASCOT_QA = (function() {
  var DB = [
    { q: ['名字','叫什么','你是谁','你的名字'], a: '我叫 BEST-辣椒，是邓恺恒的像素分身！你也可以直接叫我「辣椒」~', en_q: ['name','who are you','your name','identity'], en_a: "I’m BEST-Chili, Deng Kaiheng’s pixel avatar! You can just call me 'Chili'~" },
    { q: ['邓恺恒','主人','作者','谁做的'], a: '我的作者是邓恺恒，湖南工商大学工商管理专业，意向游戏策划/产品经理~', en_q: ['deng kaiheng','owner','author','creator','who made'], en_a: 'My creator is Deng Kaiheng, a Business Administration major at Hunan University of Technology and Business, aiming for game design / product manager roles~' },
    { q: ['干什么','干嘛','是什么','什么网站','介绍','说明','这是','干嘛的','用途','功能','有什么','有哪些','能干嘛','能做什么','有什么内容','干啥','干啥的'], a: '这是邓恺恒的求职作品集网站！包含 B站内容创作（7期视频+数据雷达）、艾瑞斯大陆世界观设定集（约3.2万字）、渡鸦镇小说（12章+性格测试）、5个可交互游戏原型（雷达评估/战斗计算器/掉落模拟等）、7款游戏策划视角拆解、文案元分析，以及游戏经历汇总。导航栏有全部入口，每个页面都有交互彩蛋——试试拖拽我到处走？', en_q: ['what','what is this','intro','introduction','about','purpose','features','what can you do','overview','what does','what site'], en_a: "This is Deng Kaiheng’s career portfolio website! It features: Bilibili content creation (7 videos + data radar), the Iris Continent worldbuilding compendium (~32,000 words), the Raven Town novel (12 chapters + personality quiz), 5 interactive game design prototypes (ability radar / combat calculator / loot simulator and more), 7 game deconstructions from a designer’s perspective, copywriting meta-analysis, and a game history summary. Everything’s in the nav bar — and every page has interactive easter eggs. Try dragging me around?" },
    { q: ['联系','邮箱','电话','怎么找','联系方式'], a: '邮箱 deng_kaiheng04@foxmail.com，电话 15807825534。更多信息在「关于」页面顶部~', en_q: ['contact','email','phone','how to reach','get in touch'], en_a: 'Email: deng_kaiheng04@foxmail.com, Phone: 15807825534. More info at the top of the About page~' },
    { q: ['学校','大学','学历','专业'], a: '湖南工商大学，工商管理专业，本科，2027年毕业。', en_q: ['school','university','degree','major','education'], en_a: 'Hunan University of Technology and Business, B.A. in Business Administration, graduating in 2027.' },
    { q: ['求职','找工作','岗位','意向','策划','产品经理'], a: '作者主投游戏策划和产品经理岗，校招方向。这个网站就是他的作品集~', en_q: ['job','looking for','position','game design','product manager','career'], en_a: "He’s targeting game design and product manager roles through campus recruitment. This website is his portfolio~" },
    ...
    { q: ['入职','到岗','报到','什么时候','毕业'], a: '2027年6月毕业，最早可以在毕业前实习或试用。具体时间可以沟通~', en_q: ['start date','onboarding','when start','graduate','available','graduation'], en_a: "Graduating June 2027. Available for internships or trial periods before graduation. Specific timing is flexible — let’s talk~" },
    ...
    { q: ['聊天','聊聊','闲聊','唠嗑','扯淡','唠会'], a: '好啊，聊什么？我可以跟你聊游戏、聊世界观设定、聊B站视频、聊作者的求职意向、聊网站的制作过程。当然，如果你只是想找人说说话，我也在~', en_q: ['chat','talk','conversation','chitchat','small talk'], en_a: "Sure, what about? I can talk games, worldbuilding, Bilibili videos, the author’s career goals, how this site was made. Or if you just want someone to talk to — I’m here~" },
