...
window.__MASCOT_QA = (function() {
  var DB = [
    ...
    { q: ['干什么','干嘛','是什么','什么网站','介绍','说明','这是','干嘛的','用途','功能','有什么','有哪些','能干嘛','能做什么','有什么内容'], a: '这是邓恺恒的求职作品集网站！包含 B站内容创作（7期视频+数据雷达）、艾瑞斯大陆世界观设定集（约3.2万字）、渡鸦镇小说（12章+性格测试）、5个可交互游戏原型（雷达评估/战斗计算器/掉落模拟等）、7款游戏策划视角拆解、文案元分析，以及游戏经历汇总。导航栏有全部入口，每个页面都有交互彩蛋——试试拖拽我到处走？' },
